...
from .views import  UserRegisterView, UserLoginView, UserUpdateView, UserChangePassword, UserProfileView, UserEditProfileView, UserAddProfileView
...
urlpatterns = [
    ...
    path('user_add_profile/', UserAddProfileView.as_view(), name="add_profile"),
